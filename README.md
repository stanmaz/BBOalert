...
Version : 3.4 (Note : Due to the long and unpredictable delays in the approval process, this version may not be available in the Chrome Webstore immediately)
