...
(function () {
    ...
    function updateColors() {
        if (cfg.enabled) {
            parent.$(".cardArea:contains('♣')").css("color", cfg.text_color_clubs);
            parent.$(".cardArea:contains('♦')").css("color", cfg.text_color_diamonds);
            parent.$(".cardArea:contains('♥')").css("color", cfg.text_color_hearts);
            parent.$(".cardArea:contains('♠')").css("color", cfg.text_color_spades);
            parent.$(".cardArea:contains('♣')").css("background-color", cfg.background_color_clubs);
            parent.$(".cardArea:contains('♦')").css("background-color", cfg.background_color_diamonds);
            parent.$(".cardArea:contains('♥')").css("background-color", cfg.background_color_hearts);
            parent.$(".cardArea:contains('♠')").css("background-color", cfg.background_color_spades);
            parent.$(".auctionBoxCellClass span:contains('♣')").css("color", cfg.text_color_clubs);
            parent.$(".auctionBoxCellClass span:contains('♦')").css("color", cfg.text_color_diamonds);
            parent.$(".auctionBoxCellClass span:contains('♥')").css("color", cfg.text_color_hearts);
            parent.$(".auctionBoxCellClass span:contains('♠')").css("color", cfg.text_color_spades);
            parent.$(".biddingBoxClass span:contains('♣')").css("color", cfg.text_color_clubs);
            parent.$(".biddingBoxClass span:contains('♦')").css("color", cfg.text_color_diamonds);
            parent.$(".biddingBoxClass span:contains('♥')").css("color", cfg.text_color_hearts);
            parent.$(".biddingBoxClass span:contains('♠')").css("color", cfg.text_color_spades);
            parent.$(".auctionBoxCellClass:contains('Dbl')").css("color", cfg.text_color_double);
            parent.$(".auctionBoxCellClass:contains('Dbl')").css("background-color", cfg.background_color_double);
            parent.$(".auctionBoxCellClass:contains('Rdbl')").css("color", cfg.text_color_redouble);
            parent.$(".auctionBoxCellClass:contains('Rdbl')").css("background-color", cfg.background_color_redouble);
        } else {
            parent.$(".cardArea:contains('♣')").css("color", "black");
            parent.$(".cardArea:contains('♦')").css("color", "");
            parent.$(".cardArea:contains('♥')").css("color", "");
            parent.$(".cardArea:contains('♠')").css("color", "black");
            parent.$(".cardArea:contains('♣')").css("background-color", "");
            parent.$(".cardArea:contains('♦')").css("background-color", "");
            parent.$(".cardArea:contains('♥')").css("background-color", "");
            parent.$(".cardArea:contains('♠')").css("background-color", "");
            parent.$(".auctionBoxCellClass span:contains('♣')").css("color", "rgb(0, 0, 0)");
            parent.$(".auctionBoxCellClass span:contains('♦')").css("color", "rgb(203, 0, 0)");
            parent.$(".auctionBoxCellClass span:contains('♥')").css("color", "rgb(203, 0, 0)");
            parent.$(".auctionBoxCellClass span:contains('♠')").css("color", "rgb(0, 0, 0)");
            parent.$(".biddingBoxClass span:contains('♣')").css("color", "");
            parent.$(".biddingBoxClass span:contains('♦')").css("color", "");
            parent.$(".biddingBoxClass span:contains('♥')").css("color", "");
            parent.$(".biddingBoxClass span:contains('♠')").css("color", "");
            parent.$(".auctionBoxCellClass:contains('Dbl')").css("color", "");
            parent.$(".auctionBoxCellClass:contains('Dbl')").css("background-color", "");
            parent.$(".auctionBoxCellClass:contains('Rdbl')").css("color", "");
            parent.$(".auctionBoxCellClass:contains('Rdbl')").css("background-color", "");
        }
    }
