...
(function () {
    ...
    function updateColors() {
        if (cfg.enabled) {
            parent.document.$(".cardArea:contains('♣')").css("color", cfg.text_color_clubs);
            parent.document.$(".cardArea:contains('♦')").css("color", cfg.text_color_diamonds);
            parent.document.$(".cardArea:contains('♥')").css("color", cfg.text_color_hearts);
            parent.document.$(".cardArea:contains('♠')").css("color", cfg.text_color_spades);
            parent.document.$(".cardArea:contains('♣')").css("background-color", cfg.background_color_clubs);
            parent.document.$(".cardArea:contains('♦')").css("background-color", cfg.background_color_diamonds);
            parent.document.$(".cardArea:contains('♥')").css("background-color", cfg.background_color_hearts);
            parent.document.$(".cardArea:contains('♠')").css("background-color", cfg.background_color_spades);
            parent.document.$(".auctionBoxCellClass span:contains('♣')").css("color", cfg.text_color_clubs);
            parent.document.$(".auctionBoxCellClass span:contains('♦')").css("color", cfg.text_color_diamonds);
            parent.document.$(".auctionBoxCellClass span:contains('♥')").css("color", cfg.text_color_hearts);
            parent.document.$(".auctionBoxCellClass span:contains('♠')").css("color", cfg.text_color_spades);
            parent.document.$(".biddingBoxClass span:contains('♣')").css("color", cfg.text_color_clubs);
            parent.document.$(".biddingBoxClass span:contains('♦')").css("color", cfg.text_color_diamonds);
            parent.document.$(".biddingBoxClass span:contains('♥')").css("color", cfg.text_color_hearts);
            parent.document.$(".biddingBoxClass span:contains('♠')").css("color", cfg.text_color_spades);
            parent.document.$(".auctionBoxCellClass:contains('Dbl')").css("color", cfg.text_color_double);
            parent.document.$(".auctionBoxCellClass:contains('Dbl')").css("background-color", cfg.background_color_double);
            parent.document.$(".auctionBoxCellClass:contains('Rdbl')").css("color", cfg.text_color_redouble);
            parent.document.$(".auctionBoxCellClass:contains('Rdbl')").css("background-color", cfg.background_color_redouble);
        } else {
            parent.document.$(".cardArea:contains('♣')").css("color", "black");
            parent.document.$(".cardArea:contains('♦')").css("color", "");
            parent.document.$(".cardArea:contains('♥')").css("color", "");
            parent.document.$(".cardArea:contains('♠')").css("color", "black");
            parent.document.$(".cardArea:contains('♣')").css("background-color", "");
            parent.document.$(".cardArea:contains('♦')").css("background-color", "");
            parent.document.$(".cardArea:contains('♥')").css("background-color", "");
            parent.document.$(".cardArea:contains('♠')").css("background-color", "");
            parent.document.$(".auctionBoxCellClass span:contains('♣')").css("color", "rgb(0, 0, 0)");
            parent.document.$(".auctionBoxCellClass span:contains('♦')").css("color", "rgb(203, 0, 0)");
            parent.document.$(".auctionBoxCellClass span:contains('♥')").css("color", "rgb(203, 0, 0)");
            parent.document.$(".auctionBoxCellClass span:contains('♠')").css("color", "rgb(0, 0, 0)");
            parent.document.$(".biddingBoxClass span:contains('♣')").css("color", "");
            parent.document.$(".biddingBoxClass span:contains('♦')").css("color", "");
            parent.document.$(".biddingBoxClass span:contains('♥')").css("color", "");
            parent.document.$(".biddingBoxClass span:contains('♠')").css("color", "");
            parent.document.$(".auctionBoxCellClass:contains('Dbl')").css("color", "");
            parent.document.$(".auctionBoxCellClass:contains('Dbl')").css("background-color", "");
            parent.document.$(".auctionBoxCellClass:contains('Rdbl')").css("color", "");
            parent.document.$(".auctionBoxCellClass:contains('Rdbl')").css("background-color", "");
        }
    }
